...
contract DeployContractsL1 is Script {
    function run() external {
        ...
        // Specific dummy operation for L1 to change nonce pattern
        // address dummyL1 = address(0x1);

        // start broadcasting transactions
        vm.startBroadcast(deployerKey);

        // Example values, replace as needed
        string memory tokenName = "Test Token L1"; // Chain specific name
        string memory tokenSymbol = "TTL1"; // Chain specific symbol
